...
// The character is named by the manifest (Kirian on the desktop, the sample character on the Tanya web demo).
export const finalizingLive2DLoadProgress = (characterName: string): Live2DLoadProgress => ({
  percent: 98,
  message: `화면에 ${characterName} 캐릭터를 준비하는 중`,
});
export const FINALIZING_LIVE2D_LOAD_PROGRESS: Live2DLoadProgress = finalizingLive2DLoadProgress("키리안");
